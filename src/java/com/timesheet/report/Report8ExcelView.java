...
public class Report8ExcelView extends AbstractExcelView {

    public static final String TRANS_LIST = null;
    protected static final short EMPNAME_COLUMN = 0;
    protected static final short PROJECT_COLUMN = 1;
    protected static final short ASSIGNBY_COLUMN = 2;
    protected static final short DATE_COLUMN = 3;
    protected static final short HOURS_COLUMN = 4;
    protected static final short TOTALHOURS_COLUMN = 5;
    ...
    protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        //CREATE THE SHEET
        HSSFSheet sheet = workbook.createSheet("Employee-Project-Assign Report");
        ...
        setText(header0, "Employee");
        header0.setCellStyle(cellStyle);

        HSSFCell header1 = getCell(sheet, currentRow, PROJECT_COLUMN);
        setText(header1, "Project");
        header1.setCellStyle(cellStyle);

        HSSFCell header2 = getCell(sheet, currentRow, ASSIGNBY_COLUMN);
        setText(header2, "AssignBy");
        header2.setCellStyle(cellStyle);

        HSSFCell header3 = getCell(sheet, currentRow, DATE_COLUMN);
        setText(header3, "Date");
        header3.setCellStyle(cellStyle);

        HSSFCell header4 = getCell(sheet, currentRow, HOURS_COLUMN);
        setText(header4, "Hours");
        header4.setCellStyle(cellStyle);

        HSSFCell header5 = getCell(sheet, currentRow, TOTALHOURS_COLUMN);
        setText(header5, "Total Hours");
