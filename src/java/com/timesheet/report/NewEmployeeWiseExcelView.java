...
public class NewEmployeeWiseExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        HSSFSheet sheet = workbook.createSheet("NewEmployeeWise Report");
...
//                    date=et.getTrans_date();
               ...
               int m = ((sh*100)/60);
                row.createCell(HOURS_COLUMN).setCellValue(+ h + "." + m);
