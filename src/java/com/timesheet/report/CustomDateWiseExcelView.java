...
public class CustomDateWiseExcelView extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        //CREATE THE SHEET
        HSSFSheet sheet = workbook.createSheet("CustomDate Report");
        ...
        HSSFCell header0 = getCell(sheet, currentRow, DATE_COLUMN);
        setText(header0, "Date");
        ...
        for (int i = 0; i < trans_list.size(); i++) {
            ...
            if (i == 0 || date.equals(et.getTrans_date())) {
                ...
                //System.out.println("rrr" +deltime1);
