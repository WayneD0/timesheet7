...
public class Report7ExcelView extends AbstractExcelView {

    public static final String TRANS_LIST = null;
    protected static final short PROJECT_COLUMN = 0;
    protected static final short ASSIGNBY_COLUMN = 1;
    ...
    protected static final short EMPNAME_COLUMN = 5;
    ...
    protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        //CREATE THE SHEET
        HSSFSheet sheet = workbook.createSheet("Project-AssignBy wise Report");
        ...
        HSSFCell header0 = getCell(sheet, currentRow, PROJECT_COLUMN);
        setText(header0, "Project");
        header0.setCellStyle(cellStyle);

        HSSFCell header1 = getCell(sheet, currentRow, ASSIGNBY_COLUMN);
        setText(header1, "AssignBy");
        ...
        HSSFCell header5 = getCell(sheet, currentRow, EMPNAME_COLUMN);
        setText(header5, "Employee");
