 ...
 * @author prodigy
 */
public class blockProjectController extends SimpleFormController {

    private ProjectService projectService;

    public blockProjectController() {
    }
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            projectService.blockproject(id);
            String msg = " Project is blocked";
