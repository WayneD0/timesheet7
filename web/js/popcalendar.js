	...
	var imgDir = "/PillTime/images/"			// directory for images ... e.g. var imgDir="/img/"
   ...
   function WeekNbr(n) {
	...
	function constructCalendar () {
		...
		document.getElementById("spanMonth").innerHTML = "&nbsp;" +	monthName[monthSelected] + "&nbsp;<IMG id='changeMonth' SRC='"+imgDir+"drop1.gif'  BORDER=0 align=absmiddle>"
		document.getElementById("spanYear").innerHTML =	"&nbsp;" + yearSelected	+ "&nbsp;<IMG id='changeYear' SRC='"+imgDir+"drop1.gif'  BORDER=0 align=absmiddle>"
	}
