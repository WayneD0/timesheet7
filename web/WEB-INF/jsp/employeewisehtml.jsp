...
<html>
    <head>
        <title>EMPLOYEEWISE HTML REPORT</title>
       ...
       <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.4.2.js"></script>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function back(type,emp){

                 document.location.href = "adminreport.htm?type='"+type+"'&empr='"+emp+"'";
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${e.dType}','${e.empr}')" title="Back">
        <div class="anotherOne">
            <center><font face="arial" style="font-size:16px;font-weight:bold;" color="#FFFFFF">EmployeewiseWise Report</font></center>
        </div>
        <form:form name="employeewisehtml" commandName="employeewisehtml" action="" method="POST">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="yearwisehtml.htm" decorator="org.displaytag.decorator.TotalTableDecorator">
                            <display:column property="year" title="Year" sortable="true" headerClass="header1"/>
                            <display:column property="month" title="Month" sortable="true" headerClass="header1" group="1"/>

                                    <display:column title="EmployeeName" sortable="true"
                                                    headerClass="header1" property="emp_fname"
                                                     paramId="emp_id" >
                                    </display:column>
                                    <display:column property="trans_date" title="Date" sortable="true" headerClass="header1"/>

                                    <display:column property="hour" title="Hours" sortable="true" headerClass="header1"/>

                                                                        <display:column property="total" title="Total Hours" sortable="true" group="1" headerClass="header1"/>
