...
<html>
    <head>
        <title>NEWMONTHWISE HTML REPORT</title>
       ...
       <link rel="stylesheet" href="default.css" type="text/css" />
        ...
        <script>
         ...
         <script type="text/javascript" language="javascript">
            ...
            function back(type,month,year){

                 
                document.location.href = "adminreport.htm?type='"+type+"'&nmonth='"+month+"'&nyear='"+year+"'";
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${e.dType}','${e.nmonth}','${e.nyear}')" title="Back">
        <div class="anotherOne">
            <center><font face="arial" style="font-size:16px;font-weight:bold;" color="#FFFFFF">MonthWIse Report</font></center>
        </div>
        <form:form name="newmonthwisehtml" commandName="newmonthwisehtml" action="monthwisehtml.htm">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="newmonthwisehtml.htm" decorator="org.displaytag.decorator.TotalTableDecorator">

                                    <display:column property="trans_date" title="Date" sortable="true" headerClass="header1" group="1"/>
                                    <display:column property="day" title="Days" sortable="true" headerClass="header1"></display:column>
                                    <display:column title="EmployeeName" sortable="true"
                                                    headerClass="header1" property="emp_fname"
                                                     paramId="emp_id" >
                                    </display:column>
                                    <display:column property="hour" title="Hours" sortable="true" headerClass="header1"></display:column>
                                                                        <display:column property="total" title="Total Hours" sortable="true" headerClass="header1" group="1"></display:column>
