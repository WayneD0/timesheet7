...
<html>
    <head>
        <title>MONTHWISE HTML REPORT</title>
       ...
       <script type="text/javascript" language="javascript">
            ...
            function back(type,month,year){
                ...
                document.location.href = "adminreport.htm?type='"+type+"'&omonth='"+month+"'&oyear='"+year+"' ";
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${e.dType}','${e.omonth}','${e.oyear}')" title="Back">
        ...
        <form:form name="monthwisehtml" commandName="monthwisehtml" action="monthwisehtml.htm">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="monthwisehtml.htm" decorator="org.displaytag.decorator.TotalTableDecorator">
