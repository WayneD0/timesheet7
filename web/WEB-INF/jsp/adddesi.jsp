...
<html>
    <head>
        ...
        <script>
            ...
            function loginfocus()
            {
                document.adddesi.desi_name.focus();
            }
            function cancel()
            {
    ...
    <body onload="loginfocus()">
        ...
        <form:form name="adddesi" commandName="adddesi">
            <div class="anotherOne bg-white" style="padding-left:15px;height:250px;">
                <table>
                    <tr>
                        <td>Designation</td>
                        <td><input style="border:1px solid #520000" type="text" maxlength="30" size="20" name="desi_name" onkeypress="return isCharKey(event)"/></td>
                        <td style="color:red;"><c:out value="${msg}" /></td>
                    </tr>

                    <tr>
                        <td></td>
                        <td><input class="button" type="submit" value="Add" title="Add Designation"/>
