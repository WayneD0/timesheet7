...
<html>
    <head>
       ...
       <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.4.2.js"></script>
        ...
        <script language="javascript">
            ...
            function back(){
                document.location.href = "employeereport.htm";
            }
        </script>
    ...
    <body>
        ...
        <form:form name="empcustomdatewisehtml" commandName="empcustomdatewisehtml" action="" method="POST">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="empcustomdatewisehtml.htm" >
                            ...
                            <display:column property="trans_date" title="Date" sortable="true" headerClass="header1" group="1"/>
                                    ...
                                    <display:column property="total" title="Total Hours" sortable="true"
                                                    headerClass="header1" group="2">
