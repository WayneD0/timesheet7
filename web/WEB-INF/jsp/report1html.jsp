...
<html>
    <head>
       ...
       <script type="text/javascript" language="javascript">
            ...
            function back(type,datec1,datec2,cat,proj){


                document.location.href = "adminreport.htm?type='"+type+"'&criteriadate1="+datec1+"&criteriadate2="+datec2+"&cat1='"+cat+"'&proj='"+proj+"'";
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${e.dType}','${e.criteriadate1}','${e.criteriadate2}','${e.cat1}','${e.proj}')" title="Back">
        <div class="anotherOne">
            <center><font face="arial" style="font-size:16px;font-weight:bold;" color="#FFFFFF">CRITERIA-WISE REPORT</font></center>
        </div>
        <form:form name="report1html" commandName="report1html" action="" method="POST">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="report1html.htm" decorator="org.displaytag.decorator.TotalTableDecorator">
                            ...
                            <display:column property="trans_date" title="Date" sortable="true" headerClass="header1" group="1"/>
                                    ...
                                    <display:column property="total" title="Total Hours" sortable="true" headerClass="header1" group="1"/>
