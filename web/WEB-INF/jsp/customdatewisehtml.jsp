...
<html>
    <head>
        <title>CUSTOM-DATEWISE REPORT</title>
       ...
       <script type="text/javascript" language="javascript">
            ...
            function back(type){
                ...
                document.location.href = "adminreport.htm?type='"+type+"'";
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${e.dType}')" title="Back">
        <div class="anotherOne">
            <center><font face="arial" style="font-size:16px;font-weight:bold;" color="#FFFFFF">Custom-DateWise Report</font></center>
        </div>
        <form:form name="customdatewisehtml" commandName="customdatewisehtml" action="" method="POST">
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${e.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="customdatewisehtml.htm" decorator="org.displaytag.decorator.TotalTableDecorator">
