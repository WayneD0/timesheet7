...
<html>
    <head>
        <title>YEARWISE HTML REPORT</title>
       ...
       <script type="text/javascript" language="javascript">
            ...
            function back(type,year){
                 document.location.href = "adminreport.htm?type='"+type+"'&year1="+year+"";
            }
        </script>
    ...
    <body>
        ...
        <input type="button" class="button" value="Back" onclick="back('${y.dType}','${y.year1}')" title="Back">
        <div class="anotherOne">
            <center><font face="arial" style="font-size:16px;font-weight:bold;" color="#FFFFFF">YearWise Report</font></center>
        </div>
        <form:form name="yearwisehtml" commandName="yearwisehtml" action="" method="POST">
            ...
            <table class="dataTable" align="center" width="100%" style="text-align:left;">
                ...
                <tr>
                    ...
                    <td colspan="2" style="border-top:1px solid #520000; ">
                        <display:table class="dataTable" name="${y.employees}"
                                       id="currentRowObject" pagesize="15" defaultsort="1"
                                        requestURI="yearwisehtml.htm">
                           
                                    <display:column property="month" title="Month" sortable="true" headerClass="header1"/>
